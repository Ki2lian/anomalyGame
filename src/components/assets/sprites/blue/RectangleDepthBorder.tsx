...
export const BlueRectangleDepthBorder = ({ size, ...props }: ComponentPropsWithoutRef<"svg"> & ISpriteProps) => {
    return (
        <svg
        ...
        >
            <g>
                ...
                <path
                    stroke="none"
                    fill="#1C9FD7"
                    d="M6 4 L186 4 Q187.65 4 188 5.35 L187.95 5.3 188 6 188 24 188 24.55 187.95 24.8 187.95 25.2 188 25.45 188 26 188 54 Q188 56 186 56 L6 56 Q4 56 4 54 L4 26 4.05 25.45 4.05 25.2 4.05 24.8 4.05 24.55 4 24 4 6 4.05 5.5 4.1 5.3 Q4.35 4 6 4 M84.7 6 L81.8 6 6 6 6 24 6 24.15 6.05 24.55 6.05 24.8 6.05 25.2 6.05 25.45 6.05 25.8 6 26 6 54 81.8 54 87.55 54 186 54 186 26 186 25.75 185.95 25.2 185.95 24.8 186 24.3 186 24 186 6 84.7 6"
                />
                <path
                    stroke="none"
                    fill="#FFFFFF"
                    d="M84.7 6 L186 6 186 24 186 24.3 185.95 24.8 185.95 25.2 186 25.75 186 26 186 54 87.55 54 81.8 54 6 54 6 26 6.05 25.8 6.05 25.45 6.05 25.2 6.05 24.8 6.05 24.55 6 24.15 6 24 6 6 81.8 6 84.7 6 M183.95 25.05 L183.95 24.95 Q183.9 24.55 184 24.1 L184 24 184 8 8 8 8 24 8.05 24.5 8.05 24.55 8.05 24.8 8.05 25.2 8.05 25.45 8 26.1 8 52 184 52 184 26 184 25.9 183.95 25.05"
                />
                <path
                    stroke="none"
                    fill="#DADCE7"
                    d="M183.95 25.05 L184 25.9 184 26 184 52 8 52 8 26.1 8.05 25.45 8.05 25.2 8.05 24.8 8.05 24.55 8.05 24.5 8 24 8 8 184 8 184 24 184 24.1 Q183.9 24.55 183.95 24.95 L183.95 25.05"
                />
