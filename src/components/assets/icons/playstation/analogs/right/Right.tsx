...
export const PlaystationRightAnalogRight = ({ size = 35, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => {
    return (
        <svg width={ size } height={ size } viewBox="0 0 120 120" preserveAspectRatio="xMidYMid" xmlSpace="preserve" { ...props }>
            <defs>
                <clipPath id="clip-Button_-_PS_Analogue_R_Right">
                    <rect width="120" height="120" />
                </clipPath>
            </defs>
            <g id="Button_-_PS_Analogue_R_Right" data-name="Button - PS Analogue R Right" clipPath="url(#clip-Button_-_PS_Analogue_R_Right)">
