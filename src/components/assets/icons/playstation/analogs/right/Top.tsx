...
export const PlaystationRightAnalogTop = ({ size = 35, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => {
    return (
        <svg width={ size } height={ size } viewBox="0 0 120 120" preserveAspectRatio="xMidYMid" xmlSpace="preserve" { ...props }>
            <defs>
                <clipPath id="clip-Button_-_PS_Analogue_R_Up">
                    <rect width="120" height="120" />
                </clipPath>
            </defs>
            <g id="Button_-_PS_Analogue_R_Up" data-name="Button - PS Analogue R Up" clipPath="url(#clip-Button_-_PS_Analogue_R_Up)">
                ...
                <g id="Button_-_Top_Alt" data-name="Button - Top Alt" transform="translate(98 90) rotate(180)">
