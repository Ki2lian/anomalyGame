...
export const PlaystationLeftAnalogRight = ({ size = 35, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => {
    return (
        <svg width={ size } height={ size } viewBox="0 0 120 120" preserveAspectRatio="xMidYMid" xmlSpace="preserve" { ...props }>
            <defs>
                <clipPath id="clip-Button_-_PS_Analogue_L_Right">
                    <rect width="120" height="120" />
                </clipPath>
            </defs>
            <g id="Button_-_PS_Analogue_L_Right" data-name="Button - PS Analogue L Right" clipPath="url(#clip-Button_-_PS_Analogue_L_Right)">
