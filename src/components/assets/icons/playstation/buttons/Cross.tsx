        ...
        <svg width={ size } height={ size } viewBox="0 0 120 120" preserveAspectRatio="xMidYMid" xmlSpace="preserve" { ...props }>
            <defs>
                <clipPath id="clipPath">
                    <circle
                        ...
                        cy="29"
                        r="29"
                        transform="translate(18.64 14.64)"
                        fill="#fff"
                        stroke="#707070"
                        strokeWidth="1"
                    />
            ...
            <g id="Button_-_PS_Cross_White_1" data-name="Button - PS Cross White 1" clipPath="url(#clip-Button_-_PS_Cross_White_1)">
                ...
                <g id="Playstation_-_Cross" data-name="Playstation - Cross" transform="translate(18.988 14.988)">
                    <g
                        id="Playstation_-_Cross-2"
                        data-name="Playstation - Cross"
                        transform="translate(38.184 -23.532) rotate(45)"
                        clipPath="url(#clipPath)"
                    >
                        <path
                            id="Union_1"
                            data-name="Union 1"
                            d="M25.292,58.076V32.785H0V25.292H25.292V0h7.493V25.292H58.076v7.493H32.785V58.076Z"
                            transform="translate(18.602 14.602)"
                            fill="#fff"
                        />
                    </g>
                </g>
