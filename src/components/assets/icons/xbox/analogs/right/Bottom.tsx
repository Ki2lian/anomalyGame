...
export const XboxRightAnalogBottom = ({ size = 35, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => {
    return (
        <svg
            width={size}
            height={size}
        ...
        >
            <defs>
                <clipPath id="clip-button_xbox_analog_r_direction_3">
                    <rect width="120" height="120"/>
                </clipPath>
            </defs>
            <g id="button_xbox_analog_r_direction_3" clipPath="url(#clip-button_xbox_analog_r_direction_3)">
                ...
                <g id="Component_12_10" data-name="Component 12 – 10" transform="translate(24 32)">
