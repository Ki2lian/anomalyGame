...
export const XboxRightAnalogLeft = ({ size = 35, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => {
    return (
        <svg
            width={size}
            height={size}
        ...
        >
            <defs>
                <clipPath id="clip-button_xbox_analog_r_direction_2">
                    <rect width="120" height="120"/>
                </clipPath>
            </defs>
            <g id="button_xbox_analog_r_direction_2" clipPath="url(#clip-button_xbox_analog_r_direction_2)">
                ...
                <g id="Component_12_9" data-name="Component 12 – 9" transform="translate(32 24)">
