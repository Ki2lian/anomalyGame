...
export const XboxRightAnalogTop = ({ size = 35, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => {
    return (
        <svg width={ size } height={ size } viewBox="0 0 120 120" preserveAspectRatio="xMidYMid" xmlSpace="preserve" { ...props }>
            ...
            <g id="button_xbox_analog_r_direction_1" clipPath="url(#clip-button_xbox_analog_r_direction_1)">
