...
export const XboxLeftAnalogLeft = ({ size = 35, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => {
    return (
        <svg
            width={size}
            height={size}
        ...
        >
            <defs>
                <clipPath id="clip-button_xbox_analog_l_direction_4">
                    <rect width="120" height="120"/>
                </clipPath>
            </defs>
            <g id="button_xbox_analog_l_direction_4" clipPath="url(#clip-button_xbox_analog_l_direction_4)">
                ...
                <g id="Component_12_15" data-name="Component 12 – 15" transform="translate(16 24)">
                ...
                <path id="Path_96" data-name="Path 96" d="M-7.705,0V-28.555H-1.65V-5H9.932V0Z" transform="translate(52 74)" fill="#fff"/>
            </g>
        </svg>
    );
};