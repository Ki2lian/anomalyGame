...
export const XboxLeftAnalogBottom = ({ size = 35, ...props }: ComponentPropsWithoutRef<"svg"> & IIconProps) => {
    return (
        <svg
            width={size}
            height={size}
        ...
        >
            <defs>
                <clipPath id="clip-button_xbox_analog_l_direction_3">
                    <rect width="120" height="120"/>
                </clipPath>
            </defs>
            <g id="button_xbox_analog_l_direction_3" clipPath="url(#clip-button_xbox_analog_l_direction_3)">
                ...
                <g id="Component_12_14" data-name="Component 12 – 14" transform="translate(24 32)">
                ...
                <path id="Path_67" data-name="Path 67" d="M-7.705,0V-28.555H-1.65V-5H9.932V0Z" transform="translate(60 82)" fill="#fff"/>
            </g>
        </svg>
    );
};